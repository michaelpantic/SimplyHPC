...
%Since ANSYS CFX is a commercial software we could not judge what is the sequential and parallel fraction of the solver. One can only speculate about the that since the performance degrades, the significant 
