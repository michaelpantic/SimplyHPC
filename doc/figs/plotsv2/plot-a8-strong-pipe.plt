...
set output "../gplt-a8-strong-pipe.pdf"
set multiplot layout 1,2 title "Strong Scaling of Ansys CFX on Azure A8 nodes"
...
plot '../../results/ansys/pipe/A8/results.dat'  using 1:2 w linespoints ls 11 title 'pipe01', \
...
plot '../../results/ansys/pipe/A8/results.dat'  using 1:6 w linespoints ls 11 title 'pipe01', \
