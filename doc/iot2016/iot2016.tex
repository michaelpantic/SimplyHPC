...
\keywords{Microsoft Azure, high performance computing, cloud computing, computational fluid dynamics, software framework, simulations	}
...
%\begin{table}[ht]
	...
	%\label{tab:CommandletsOfSimplyHPC} \centering
%\end{table}
%
%\twocolumn
